			...
			<div class="prodetail-slider cFix">
				...
				<div class="prodetail-sliderR">
					<div class="sliderR-inner">
						...
						<p class="fz-r-jp fz-15 txt-center-sp"><?php the_field('pro_type'); ?> <?php the_field('text01'); ?></p>
						<p class="sliderR-txt fz-r-jp fz-15"><span>※賞味期限:</span><?php the_field('text02'); ?></p>
						...
						<?php
						echo do_shortcode('[product_page id="1244"]');
						?>
						...
						">
								...
								<a href="<?php echo esc_url(add_query_arg('clear_wc_cart', '1')); ?>" class="button">
										Clear Cart
								</a>
						...
						<p class="sliderR-txt01 fz-r-jp fz-15"><?php the_field('blacktext'); ?></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="m-width900">
			<div class="m-width725">
				<section class="oneday-amount">
					<div class="midashi02">
						<p class="fz-m-jp fz-16 detail-p0"><?php echo the_title(); ?>の</p>
					...
					<div class="amount-table">
						<table>
							...
							<tr>
								<th>犬種</th>
								<th>犬の体重<span class="fz-20">（kg）</span></th>
								<th>給与量<span class="fz-20">（g）</span></th>
							</tr>
							<?php $repeat_group = SCF::get( 'az_table01'); ?>
							<?php foreach ( $repeat_group as $fields ) { ?>
							<tr>
								<td><?php echo $fields['type'];?></td>
								<td><?php echo $fields['weight'];?></td>
								<td><?php echo $fields['amount'];?></td>
							</tr>
							<?php } ?>
						</table>
				...
				<section class="preserve-method">
					...
					<ul class="preserve-ls col-wrap">
						<li class="col3 col1-sp">
							<div class="preserve-box">
								<div class="preserve-pos img-pos">
									<div class="pro-img">
										<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/az_adult001/preserve_img01.png" alt="">
									</div>
								</div>
						...
						<li class="col3 col1-sp">
							<div class="preserve-box">
								<div class="preserve-pos img-pos">
									<div class="pro-img">
										<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/az_adult001/preserve_img02.png" alt="">
									</div>
								</div>
								<div class="preserve-desp">
									<p class="fz-r-jp fz-15">
						...
						<li class="col3 col1-sp">
							<div class="preserve-box">
								<div class="preserve-pos img-pos">
									<div class="pro-img">
										<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/az_adult001/preserve_img03.png" alt="">
									</div>
								</div>
								<div class="preserve-desp">
									<p class="fz-r-jp fz-15">
										AZ商品(ドッグフード)の10kgは2.5kg×4のパックに小分けしております。<br class="pc">大口購入頂きましても、開封による劣化の心配はありません。
									</p>
								</div>
							</div>
						</li>
					...
					<div class="seibun-block">
						<ul class="col-wrap">
							<li class="col2 col1-sp">
								<div class="sec-tb02">
									<p class="sec-tb02ttl pc">カロリー</p>
									<table class="tb-height fz-15">
										<colgroup>
											<col class="td1 bg-green1" width="15%">
											<col class="td2 bg-green2" width="32%">
											<col class="td3" width="53%">
										</colgroup>
										<?php $cal_ttlamount = SCF::get( 'cal_ttlamount' ); ?>
										<?php $cal_type01 = SCF::get( 'cal_type01' ); ?>
										<?php $cal_amount01 = SCF::get( 'cal_amount01' ); ?>
										<?php $repeat_group = SCF::get( 'az_cal'); ?>
										<?php $count = 0; ?>
										<?php foreach ( $repeat_group as $fields ) {
							...
							<li class="col2 col1-sp">
								<div class="sec-tb02 seibun-cal">
									<p class="sec-tb02ttl pc"><?php echo $cal_ttlamount; ?></p>
									<table class="tb-height fz-15">
										<colgroup>
											<col class="td1 bg-green1" width="15%">
											<col class="td2 bg-green2" width="33%">
											<col class="td3" width="52%">
										</colgroup>
										<?php $cal_type02 = SCF::get( 'cal_type02' ); ?>
										<?php $cal_amount02 = SCF::get( 'cal_amount02' ); ?>
										<?php $repeat_group = SCF::get( 'az_cal_right'); ?>
										<?php $count02 = 0; ?>
										<?php foreach ( $repeat_group as $fields ) {
												$type_count02 = $fields['cal_add_type'];
												if ($type_count02) {
													$count02 = $count02 + 1;
												}
											}
										?>
										<tr>
											<td rowspan="<?php echo $count02+1; ?>" class="td-first"><p>添加成分</p></td>
											<td class="td-nd"><?php echo $cal_type02;?></td>
											<td class="td-bdr td-bdr0"><?php echo $cal_amount02;?></td>
										</tr>
										<?php foreach ( $repeat_group as $fields ) {?>
										<?php $have_td2 =  $fields['cal_add_type'];?>
										<?php if ($have_td2): ?>
										<tr>
											<td class="td-nd"><?php echo $fields['cal_add_type'];?></td>
											<td><?php echo $fields['cal_add_amount'];?></td>
										</tr>
										<?php endif ?>
										<?php } ?>
									</table>
						...
						<p class="fz-r-jp fz-15 mt15">●原材料および添加成分</p>
						<p class="fz-r-jp fz-14"><?php echo $remark02; ?></p>
						<?php $remark04 = SCF::get( 'remark04' ); ?>
						<p class="fz-l-jp fz-13 mt10"><?php echo $remark04; ?></p>
					</div>
				</section>
