	...
	<div id="breadcrumb" class="breadcrumb">
		<div class="m-width900">
			<ul class="crumb-ls cFix">
				...
				<li><p class="current"><?php echo the_title(); ?></p></li>
			</ul>
		</div>
	</div>
			...
			<div class="prodetail-slider cFix">
				...
				<div class="prodetail-sliderR">
					<div class="sliderR-inner">
						<h2 class="sliderR-ttl fz-m-jp fz-21 txt-black01 mt20 mt20-sp"><?php echo the_title(); ?><span class="fz-r-jp fz-15"></span></h2>
				...
				<section class="oneday-amount">
					...
					<div class="amount-table">
						<table>
							...
							<?php $repeat_group = SCF::get( 'kokusan_table01'); ?>
							...
							<li class="col2 col1-sp">
								<div class="sec-tb02">
									...
									<table class="tb-height fz-15">
										...
										<?php $repeat_group = SCF::get( 'kokusanfood_cal'); ?>
										<?php $count = 0; ?>
										<?php foreach ( $repeat_group as $fields ) {
							...
							<li class="col2 col1-sp">
								<div class="sec-tb02 seibun-cal">
									...
									<table class="tb-height fz-15">
										...
										<?php $repeat_group = SCF::get( 'kokusanfood_cal_right'); ?>
										<?php $count02 = 0; ?>
										<?php foreach ( $repeat_group as $fields ) {
